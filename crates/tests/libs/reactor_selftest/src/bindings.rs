...
impl core::ops::Deref for ButtonAutomationPeer {
    type Target = IButtonAutomationPeer;
    fn deref(&self) -> &Self::Target {
        unsafe { core::mem::transmute(self) }
    }
}
...
impl core::ops::Deref for ButtonBaseAutomationPeer {
    type Target = IButtonBaseAutomationPeer;
    fn deref(&self) -> &Self::Target {
        unsafe { core::mem::transmute(self) }
    }
}
...
impl INumberFormatter2 {
    pub(crate) fn FormatInt(&self, value: i64) -> windows_core::Result<String> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FormatInt)(
                windows_core::Interface::as_raw(self),
                value,
                &mut result__,
            )
    ...
    pub(crate) fn FormatUInt(&self, value: u64) -> windows_core::Result<String> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FormatUInt)(
                windows_core::Interface::as_raw(self),
                value,
                &mut result__,
            )
    ...
    pub(crate) fn FormatDouble(&self, value: f64) -> windows_core::Result<String> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FormatDouble)(
                windows_core::Interface::as_raw(self),
                value,
                &mut result__,
            )
...
pub trait ISwapChainPanelNative_Impl: windows_core::IUnknownImpl {
    fn SetSwapChain(&self, swapchain: *mut core::ffi::c_void) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: ISwapChainPanelNative_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISwapChainPanelNative_Impl::SetSwapChain(
                    this,
...
impl ITaskbarList3 {
    pub(crate) unsafe fn SetProgressValue(
        &self,
        hwnd: HWND,
        ullcompleted: u64,
        ulltotal: u64,
...
pub struct ITaskbarList3_Vtbl {
    ...
    pub SetProgressValue:
        unsafe extern "system" fn(*mut core::ffi::c_void, HWND, u64, u64) -> windows_core::HRESULT,
    pub SetProgressState:
        unsafe extern "system" fn(*mut core::ffi::c_void, HWND, TBPFLAG) -> windows_core::HRESULT,
    RegisterTab: usize,
    UnregisterTab: usize,
    SetTabOrder: usize,
    SetTabActive: usize,
...
impl IVirtualSurfaceImageSourceNative {
    pub(crate) unsafe fn Invalidate(&self, updaterect: RECT) -> windows_core::HRESULT {
        unsafe {
    ...
    pub(crate) unsafe fn Resize(&self, newwidth: i32, newheight: i32) -> windows_core::HRESULT {
        unsafe {
...
impl IVirtualSurfaceUpdatesCallbackNative {
    pub(crate) unsafe fn UpdatesNeeded(&self) -> windows_core::HRESULT {
        unsafe {
...
impl IVirtualSurfaceUpdatesCallbackNative_Vtbl {
    pub const fn new<Identity: IVirtualSurfaceUpdatesCallbackNative_Impl, const OFFSET: isize>()
    -> Self {
        unsafe extern "system" fn UpdatesNeeded<
            Identity: IVirtualSurfaceUpdatesCallbackNative_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            UpdatesNeeded: UpdatesNeeded::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const TaskbarList: windows_core::GUID =
    windows_core::GUID::from_u128(0x56fdf344_fd6d_11d0_958a_006097c9a090);
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
