...
fn cases() -> Vec<Case> {
    let mut cases: Vec<Case> = vec![
        ...
        // ── Paint, zero-valued ───────────────────────────────────────────
        c(K::Border, Prop::Background, V::Color(Color::rgb(1, 2, 3))),
        ...
        c(K::Rectangle, Prop::Fill, V::Color(Color::rgb(9, 9, 9))),
        ...
        c(K::Slider, Prop::FillColor, V::Color(Color::rgb(4, 5, 6))),
        c(K::Meter, Prop::Marker, V::F64(2.0)),
        c(
            K::Meter,
            Prop::GradientStops,
            V::GradientStops(vec![(0.5, Color::rgb(1, 1, 1))]),
        ),
        ...
        c(K::Knob, Prop::Accent, V::Color(Color::rgb(7, 8, 9))),
        ...
        // ── Extras, zero-valued ──────────────────────────────────────────
        c(K::TitleBar, Prop::Title, V::Str("Reactor".into())),
        ...
        c(K::HyperlinkButton, Prop::NavigateUri, V::Str("https://example.com".into())),
