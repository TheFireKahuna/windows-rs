...
fn main() -> windows_reactor::Result<()> {
    ...
    const CARD: Color = Color { a: 255, r: 0x28, g: 0x28, b: 0x28 };
    const PANEL: Color = Color { a: 255, r: 0x1c, g: 0x1c, b: 0x1c };
    const TXT: Color = Color { a: 255, r: 0xff, g: 0xff, b: 0xff };
    const TXT2: Color = Color { a: 255, r: 0xaa, g: 0xaa, b: 0xaa };
