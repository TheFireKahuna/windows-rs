...
windows_link::link!("uiautomationcore.dll" "system" fn DockPattern_SetDockPosition(hobj : HUIAPATTERNOBJECT, dockposition : super::DockPosition) -> windows_sys::core::HRESULT);
...
windows_link::link!("uiautomationcore.dll" "system" fn ItemContainerPattern_FindItemByProperty(hobj : HUIAPATTERNOBJECT, hnodestartafter : HUIANODE, propertyid : super::PROPERTYID, value : super::VARIANT, pfound : *mut HUIANODE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn ScrollPattern_Scroll(hobj : HUIAPATTERNOBJECT, horizontalamount : super::ScrollAmount, verticalamount : super::ScrollAmount) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn SynchronizedInputPattern_StartListening(hobj : HUIAPATTERNOBJECT, inputtype : super::SynchronizedInputType) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_GetSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_GetVisibleRanges(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_RangeFromPoint(hobj : HUIAPATTERNOBJECT, point : super::UiaPoint, pretval : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_get_SupportedTextSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut super::SupportedTextSelection) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_CompareEndpoints(hobj : HUIATEXTRANGE, endpoint : super::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::TextPatternRangeEndpoint, pretval : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_ExpandToEnclosingUnit(hobj : HUIATEXTRANGE, unit : super::TextUnit) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_FindAttribute(hobj : HUIATEXTRANGE, attributeid : super::TEXTATTRIBUTEID, val : super::VARIANT, backward : windows_sys::core::BOOL, pretval : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
...
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetAttributeValue(hobj : HUIATEXTRANGE, attributeid : super::TEXTATTRIBUTEID, pretval : *mut super::VARIANT) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetBoundingRectangles(hobj : HUIATEXTRANGE, pretval : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetChildren(hobj : HUIATEXTRANGE, pretval : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_Move(hobj : HUIATEXTRANGE, unit : super::TextUnit, count : i32, pretval : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByRange(hobj : HUIATEXTRANGE, endpoint : super::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::TextPatternRangeEndpoint) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByUnit(hobj : HUIATEXTRANGE, endpoint : super::TextPatternRangeEndpoint, unit : super::TextUnit, count : i32, pretval : *mut i32) -> windows_sys::core::HRESULT);
...
windows_link::link!("uiautomationcore.dll" "system" fn UiaAddEvent(hnode : HUIANODE, eventid : super::EVENTID, pcallback : UiaEventCallback, scope : TreeScope, pproperties : *mut super::PROPERTYID, cproperties : i32, prequest : *mut UiaCacheRequest, phevent : *mut HUIAEVENT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaEventAddWindow(hevent : HUIAEVENT, hwnd : super::HWND) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaEventRemoveWindow(hevent : HUIAEVENT, hwnd : super::HWND) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaFind(hnode : HUIANODE, pparams : *mut UiaFindParams, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::SAFEARRAY, ppoffsets : *mut *mut super::SAFEARRAY, pptreestructures : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetPatternProvider(hnode : HUIANODE, patternid : super::PATTERNID, phobj : *mut HUIAPATTERNOBJECT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetPropertyValue(hnode : HUIANODE, propertyid : super::PROPERTYID, pvalue : *mut super::VARIANT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetRuntimeId(hnode : HUIANODE, pruntimeid : *mut *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetUpdatedCache(hnode : HUIANODE, prequest : *mut UiaCacheRequest, normalizestate : NormalizeState, pnormalizecondition : *mut UiaCondition, pprequesteddata : *mut *mut super::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHPatternObjectFromVariant(pvar : *mut super::VARIANT, phobj : *mut HUIAPATTERNOBJECT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHTextRangeFromVariant(pvar : *mut super::VARIANT, phtextrange : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHUiaNodeFromVariant(pvar : *mut super::VARIANT, phnode : *mut HUIANODE) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHasServerSideProvider(hwnd : super::HWND) -> windows_sys::core::BOOL);
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHostProviderFromHwnd(hwnd : super::HWND, ppprovider : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "oleacc", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaIAccessibleFromProvider(pprovider : *mut core::ffi::c_void, dwflags : u32, ppaccessible : *mut *mut core::ffi::c_void, pvarchild : *mut super::VARIANT) -> windows_sys::core::HRESULT);
...
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNavigate(hnode : HUIANODE, direction : super::NavigateDirection, pcondition : *mut UiaCondition, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromFocus(prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromHandle(hwnd : super::HWND, phnode : *mut HUIANODE) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromPoint(x : f64, y : f64, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
...
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaProviderForNonClient(hwnd : super::HWND, idobject : i32, idchild : i32, ppprovider : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationEvent(pprovider : *mut core::ffi::c_void, id : super::EVENTID) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationPropertyChangedEvent(pprovider : *mut core::ffi::c_void, id : super::PROPERTYID, oldvalue : super::VARIANT, newvalue : super::VARIANT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseChangesEvent(pprovider : *mut core::ffi::c_void, eventidcount : i32, puiachanges : *mut super::UiaChangeInfo) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseNotificationEvent(provider : *mut core::ffi::c_void, notificationkind : super::NotificationKind, notificationprocessing : super::NotificationProcessing, displaystring : windows_sys::core::BSTR, activityid : windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseStructureChangedEvent(pprovider : *mut core::ffi::c_void, structurechangetype : super::StructureChangeType, pruntimeid : *mut i32, cruntimeidlen : i32) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseTextEditTextChangedEvent(pprovider : *mut core::ffi::c_void, texteditchangetype : super::TextEditChangeType, pchangeddata : *mut super::SAFEARRAY) -> windows_sys::core::HRESULT);
...
windows_link::link!("uiautomationcore.dll" "system" fn UiaReturnRawElementProvider(hwnd : super::HWND, wparam : super::WPARAM, lparam : super::LPARAM, el : *mut core::ffi::c_void) -> super::LRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn WindowPattern_SetWindowVisualState(hobj : HUIAPATTERNOBJECT, state : super::WindowVisualState) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "oaidl")]
pub type UiaEventCallback = Option<unsafe extern "system" fn(pargs: *mut UiaEventArgs, prequesteddata: *mut super::SAFEARRAY, ptreestructure: windows_sys::core::BSTR)>;
#[repr(C)]
#[derive(Clone, Copy)]
