...
windows_link::link!("uiautomationcore.dll" "system" fn DockPattern_SetDockPosition(hobj : HUIAPATTERNOBJECT, dockposition : super::uiautomationcore::DockPosition) -> windows_sys::core::HRESULT);
...
windows_link::link!("uiautomationcore.dll" "system" fn ItemContainerPattern_FindItemByProperty(hobj : HUIAPATTERNOBJECT, hnodestartafter : HUIANODE, propertyid : super::uiautomationcore::PROPERTYID, value : super::oaidl::VARIANT, pfound : *mut HUIANODE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn ScrollPattern_Scroll(hobj : HUIAPATTERNOBJECT, horizontalamount : super::uiautomationcore::ScrollAmount, verticalamount : super::uiautomationcore::ScrollAmount) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn SynchronizedInputPattern_StartListening(hobj : HUIAPATTERNOBJECT, inputtype : super::uiautomationcore::SynchronizedInputType) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_GetSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_GetVisibleRanges(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_RangeFromPoint(hobj : HUIAPATTERNOBJECT, point : super::uiautomationcore::UiaPoint, pretval : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextPattern_get_SupportedTextSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut super::uiautomationcore::SupportedTextSelection) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_CompareEndpoints(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::uiautomationcore::TextPatternRangeEndpoint, pretval : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_ExpandToEnclosingUnit(hobj : HUIATEXTRANGE, unit : super::uiautomationcore::TextUnit) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_FindAttribute(hobj : HUIATEXTRANGE, attributeid : super::uiautomationcore::TEXTATTRIBUTEID, val : super::oaidl::VARIANT, backward : windows_sys::core::BOOL, pretval : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
...
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetAttributeValue(hobj : HUIATEXTRANGE, attributeid : super::uiautomationcore::TEXTATTRIBUTEID, pretval : *mut super::oaidl::VARIANT) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetBoundingRectangles(hobj : HUIATEXTRANGE, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_GetChildren(hobj : HUIATEXTRANGE, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_Move(hobj : HUIATEXTRANGE, unit : super::uiautomationcore::TextUnit, count : i32, pretval : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByRange(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::uiautomationcore::TextPatternRangeEndpoint) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByUnit(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, unit : super::uiautomationcore::TextUnit, count : i32, pretval : *mut i32) -> windows_sys::core::HRESULT);
...
windows_link::link!("uiautomationcore.dll" "system" fn UiaAddEvent(hnode : HUIANODE, eventid : super::uiautomationcore::EVENTID, pcallback : UiaEventCallback, scope : TreeScope, pproperties : *mut super::uiautomationcore::PROPERTYID, cproperties : i32, prequest : *mut UiaCacheRequest, phevent : *mut HUIAEVENT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaEventAddWindow(hevent : HUIAEVENT, hwnd : super::windef::HWND) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaEventRemoveWindow(hevent : HUIAEVENT, hwnd : super::windef::HWND) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaFind(hnode : HUIANODE, pparams : *mut UiaFindParams, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, ppoffsets : *mut *mut super::oaidl::SAFEARRAY, pptreestructures : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetPatternProvider(hnode : HUIANODE, patternid : super::uiautomationcore::PATTERNID, phobj : *mut HUIAPATTERNOBJECT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetPropertyValue(hnode : HUIANODE, propertyid : super::uiautomationcore::PROPERTYID, pvalue : *mut super::oaidl::VARIANT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "oaidl")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetRuntimeId(hnode : HUIANODE, pruntimeid : *mut *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaGetUpdatedCache(hnode : HUIANODE, prequest : *mut UiaCacheRequest, normalizestate : NormalizeState, pnormalizecondition : *mut UiaCondition, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHPatternObjectFromVariant(pvar : *mut super::oaidl::VARIANT, phobj : *mut HUIAPATTERNOBJECT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHTextRangeFromVariant(pvar : *mut super::oaidl::VARIANT, phtextrange : *mut HUIATEXTRANGE) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHUiaNodeFromVariant(pvar : *mut super::oaidl::VARIANT, phnode : *mut HUIANODE) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHasServerSideProvider(hwnd : super::windef::HWND) -> windows_sys::core::BOOL);
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaHostProviderFromHwnd(hwnd : super::windef::HWND, ppprovider : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "oleacc", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaIAccessibleFromProvider(pprovider : *mut core::ffi::c_void, dwflags : u32, ppaccessible : *mut *mut core::ffi::c_void, pvarchild : *mut super::oaidl::VARIANT) -> windows_sys::core::HRESULT);
...
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNavigate(hnode : HUIANODE, direction : super::uiautomationcore::NavigateDirection, pcondition : *mut UiaCondition, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromFocus(prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "windef")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromHandle(hwnd : super::windef::HWND, phnode : *mut HUIANODE) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaNodeFromPoint(x : f64, y : f64, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
...
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaProviderForNonClient(hwnd : super::windef::HWND, idobject : i32, idchild : i32, ppprovider : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationEvent(pprovider : *mut core::ffi::c_void, id : super::uiautomationcore::EVENTID) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationPropertyChangedEvent(pprovider : *mut core::ffi::c_void, id : super::uiautomationcore::PROPERTYID, oldvalue : super::oaidl::VARIANT, newvalue : super::oaidl::VARIANT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseChangesEvent(pprovider : *mut core::ffi::c_void, eventidcount : i32, puiachanges : *mut super::uiautomationcore::UiaChangeInfo) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseNotificationEvent(provider : *mut core::ffi::c_void, notificationkind : super::uiautomationcore::NotificationKind, notificationprocessing : super::uiautomationcore::NotificationProcessing, displaystring : windows_sys::core::BSTR, activityid : windows_sys::core::BSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseStructureChangedEvent(pprovider : *mut core::ffi::c_void, structurechangetype : super::uiautomationcore::StructureChangeType, pruntimeid : *mut i32, cruntimeidlen : i32) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRaiseTextEditTextChangedEvent(pprovider : *mut core::ffi::c_void, texteditchangetype : super::uiautomationcore::TextEditChangeType, pchangeddata : *mut super::oaidl::SAFEARRAY) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "oaidl", feature = "windef"))]
windows_link::link!("uiautomationcore.dll" "system" fn UiaRegisterProviderCallback(pcallback : UiaProviderCallback));
...
windows_link::link!("uiautomationcore.dll" "system" fn UiaReturnRawElementProvider(hwnd : super::windef::HWND, wparam : super::minwindef::WPARAM, lparam : super::minwindef::LPARAM, el : *mut core::ffi::c_void) -> super::minwindef::LRESULT);
...
#[cfg(feature = "uiautomationcore")]
windows_link::link!("uiautomationcore.dll" "system" fn WindowPattern_SetWindowVisualState(hobj : HUIAPATTERNOBJECT, state : super::uiautomationcore::WindowVisualState) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "oaidl")]
pub type UiaEventCallback = Option<unsafe extern "system" fn(pargs: *mut UiaEventArgs, prequesteddata: *mut super::oaidl::SAFEARRAY, ptreestructure: windows_sys::core::BSTR)>;
#[repr(C)]
#[derive(Clone, Copy)]
