#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmAttachMilContent(hwnd: super::HWND) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmAttachMilContent(hwnd : super::HWND) -> windows_core::HRESULT);
    unsafe { DwmAttachMilContent(hwnd) }
}
#[cfg(all(feature = "minwindef", feature = "windef"))]
#[inline]
pub unsafe fn DwmDefWindowProc(hwnd: super::HWND, msg: u32, wparam: super::WPARAM, lparam: super::LPARAM, plresult: *mut super::LRESULT) -> windows_core::BOOL {
    windows_core::link!("dwmapi.dll" "system" fn DwmDefWindowProc(hwnd : super::HWND, msg : u32, wparam : super::WPARAM, lparam : super::LPARAM, plresult : *mut super::LRESULT) -> windows_core::BOOL);
    unsafe { DwmDefWindowProc(hwnd, msg, wparam, lparam, plresult as _) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmDetachMilContent(hwnd: super::HWND) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmDetachMilContent(hwnd : super::HWND) -> windows_core::HRESULT);
    unsafe { DwmDetachMilContent(hwnd) }
}
#[cfg(all(feature = "minwindef", feature = "windef"))]
#[inline]
pub unsafe fn DwmEnableBlurBehindWindow(hwnd: super::HWND, pblurbehind: *const DWM_BLURBEHIND) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmEnableBlurBehindWindow(hwnd : super::HWND, pblurbehind : *const DWM_BLURBEHIND) -> windows_core::HRESULT);
...
#[inline]
pub unsafe fn DwmExtendFrameIntoClientArea(hwnd: super::HWND, pmarinset: *const super::MARGINS) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmExtendFrameIntoClientArea(hwnd : super::HWND, pmarinset : *const super::MARGINS) -> windows_core::HRESULT);
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmGetCompositionTimingInfo(hwnd: super::HWND, ptiminginfo: *mut DWM_TIMING_INFO) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmGetCompositionTimingInfo(hwnd : super::HWND, ptiminginfo : *mut DWM_TIMING_INFO) -> windows_core::HRESULT);
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmGetUnmetTabRequirements(appwindow: Option<super::HWND>) -> windows_core::Result<DWM_TAB_WINDOW_REQUIREMENTS> {
    windows_core::link!("dwmapi.dll" "system" fn DwmGetUnmetTabRequirements(appwindow : super::HWND, value : *mut DWM_TAB_WINDOW_REQUIREMENTS) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmGetWindowAttribute(hwnd: super::HWND, dwattribute: u32, pvattribute: *mut core::ffi::c_void, cbattribute: u32) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmGetWindowAttribute(hwnd : super::HWND, dwattribute : u32, pvattribute : *mut core::ffi::c_void, cbattribute : u32) -> windows_core::HRESULT);
    unsafe { DwmGetWindowAttribute(hwnd, dwattribute, pvattribute as _, cbattribute) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmInvalidateIconicBitmaps(hwnd: super::HWND) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmInvalidateIconicBitmaps(hwnd : super::HWND) -> windows_core::HRESULT);
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmModifyPreviousDxFrameDuration(hwnd: super::HWND, crefreshes: i32, frelative: bool) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmModifyPreviousDxFrameDuration(hwnd : super::HWND, crefreshes : i32, frelative : windows_core::BOOL) -> windows_core::HRESULT);
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmRenderGesture(gt: GESTURE_TYPE, ccontacts: u32, pdwpointerid: *const u32, ppoints: *const super::POINT) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmRenderGesture(gt : GESTURE_TYPE, ccontacts : u32, pdwpointerid : *const u32, ppoints : *const super::POINT) -> windows_core::HRESULT);
    unsafe { DwmRenderGesture(gt, ccontacts, pdwpointerid, ppoints) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmSetDxFrameDuration(hwnd: super::HWND, crefreshes: i32) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmSetDxFrameDuration(hwnd : super::HWND, crefreshes : i32) -> windows_core::HRESULT);
    unsafe { DwmSetDxFrameDuration(hwnd, crefreshes) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmSetIconicLivePreviewBitmap(hwnd: super::HWND, hbmp: super::HBITMAP, pptclient: Option<*const super::POINT>, dwsitflags: u32) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmSetIconicLivePreviewBitmap(hwnd : super::HWND, hbmp : super::HBITMAP, pptclient : *const super::POINT, dwsitflags : u32) -> windows_core::HRESULT);
    unsafe { DwmSetIconicLivePreviewBitmap(hwnd, hbmp, pptclient.unwrap_or(core::mem::zeroed()) as _, dwsitflags) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmSetIconicThumbnail(hwnd: super::HWND, hbmp: super::HBITMAP, dwsitflags: u32) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmSetIconicThumbnail(hwnd : super::HWND, hbmp : super::HBITMAP, dwsitflags : u32) -> windows_core::HRESULT);
    unsafe { DwmSetIconicThumbnail(hwnd, hbmp, dwsitflags) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmSetPresentParameters(hwnd: super::HWND, ppresentparams: *mut DWM_PRESENT_PARAMETERS) -> windows_core::HRESULT {
...
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmTetherContact(dwpointerid: u32, fenable: bool, pttether: super::POINT) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmTetherContact(dwpointerid : u32, fenable : windows_core::BOOL, pttether : super::POINT) -> windows_core::HRESULT);
    unsafe { DwmTetherContact(dwpointerid, fenable.into(), pttether) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DwmTransitionOwnedWindow(hwnd: super::HWND, target: DWMTRANSITION_OWNEDWINDOW_TARGET) -> windows_core::HRESULT {
    windows_core::link!("dwmapi.dll" "system" fn DwmTransitionOwnedWindow(hwnd : super::HWND, target : DWMTRANSITION_OWNEDWINDOW_TARGET) -> windows_core::HRESULT);
