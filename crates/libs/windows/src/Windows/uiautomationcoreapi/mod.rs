...
#[inline]
pub unsafe fn DockPattern_SetDockPosition(hobj: HUIAPATTERNOBJECT, dockposition: super::uiautomationcore::DockPosition) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn DockPattern_SetDockPosition(hobj : HUIAPATTERNOBJECT, dockposition : super::uiautomationcore::DockPosition) -> windows_core::HRESULT);
    unsafe { DockPattern_SetDockPosition(hobj, dockposition) }
}
#[inline]
pub unsafe fn ExpandCollapsePattern_Collapse(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn ExpandCollapsePattern_Collapse(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { ExpandCollapsePattern_Collapse(hobj) }
}
#[inline]
pub unsafe fn ExpandCollapsePattern_Expand(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn ExpandCollapsePattern_Expand(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { ExpandCollapsePattern_Expand(hobj) }
}
#[inline]
pub unsafe fn GridPattern_GetItem(hobj: HUIAPATTERNOBJECT, row: i32, column: i32) -> windows_core::Result<HUIANODE> {
    windows_core::link!("uiautomationcore.dll" "system" fn GridPattern_GetItem(hobj : HUIAPATTERNOBJECT, row : i32, column : i32, presult : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        GridPattern_GetItem(hobj, row, column, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn InvokePattern_Invoke(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn InvokePattern_Invoke(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { InvokePattern_Invoke(hobj) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn ItemContainerPattern_FindItemByProperty(hobj: HUIAPATTERNOBJECT, hnodestartafter: HUIANODE, propertyid: super::uiautomationcore::PROPERTYID, value: &super::oaidl::VARIANT) -> windows_core::Result<HUIANODE> {
    windows_core::link!("uiautomationcore.dll" "system" fn ItemContainerPattern_FindItemByProperty(hobj : HUIAPATTERNOBJECT, hnodestartafter : HUIANODE, propertyid : super::uiautomationcore::PROPERTYID, value : super::oaidl::VARIANT, pfound : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        ItemContainerPattern_FindItemByProperty(hobj, hnodestartafter, propertyid, core::mem::transmute_copy(value), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn LegacyIAccessiblePattern_DoDefaultAction(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn LegacyIAccessiblePattern_DoDefaultAction(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { LegacyIAccessiblePattern_DoDefaultAction(hobj) }
}
#[cfg(all(feature = "oaidl", feature = "oleacc"))]
#[inline]
pub unsafe fn LegacyIAccessiblePattern_GetIAccessible(hobj: HUIAPATTERNOBJECT) -> windows_core::Result<super::oleacc::IAccessible> {
    windows_core::link!("uiautomationcore.dll" "system" fn LegacyIAccessiblePattern_GetIAccessible(hobj : HUIAPATTERNOBJECT, paccessible : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn LegacyIAccessiblePattern_Select(hobj: HUIAPATTERNOBJECT, flagsselect: i32) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn LegacyIAccessiblePattern_Select(hobj : HUIAPATTERNOBJECT, flagsselect : i32) -> windows_core::HRESULT);
    unsafe { LegacyIAccessiblePattern_Select(hobj, flagsselect) }
}
#[inline]
pub unsafe fn LegacyIAccessiblePattern_SetValue<P1>(hobj: HUIAPATTERNOBJECT, szvalue: P1) -> windows_core::HRESULT
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { LegacyIAccessiblePattern_SetValue(hobj, szvalue.param().abi()) }
}
#[inline]
pub unsafe fn MultipleViewPattern_GetViewName(hobj: HUIAPATTERNOBJECT, viewid: i32) -> windows_core::Result<windows_core::BSTR> {
    windows_core::link!("uiautomationcore.dll" "system" fn MultipleViewPattern_GetViewName(hobj : HUIAPATTERNOBJECT, viewid : i32, ppstr : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        MultipleViewPattern_GetViewName(hobj, viewid, &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn MultipleViewPattern_SetCurrentView(hobj: HUIAPATTERNOBJECT, viewid: i32) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn MultipleViewPattern_SetCurrentView(hobj : HUIAPATTERNOBJECT, viewid : i32) -> windows_core::HRESULT);
    unsafe { MultipleViewPattern_SetCurrentView(hobj, viewid) }
}
#[inline]
pub unsafe fn RangeValuePattern_SetValue(hobj: HUIAPATTERNOBJECT, val: f64) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn RangeValuePattern_SetValue(hobj : HUIAPATTERNOBJECT, val : f64) -> windows_core::HRESULT);
    unsafe { RangeValuePattern_SetValue(hobj, val) }
}
#[inline]
pub unsafe fn ScrollItemPattern_ScrollIntoView(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn ScrollItemPattern_ScrollIntoView(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { ScrollItemPattern_ScrollIntoView(hobj) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn ScrollPattern_Scroll(hobj: HUIAPATTERNOBJECT, horizontalamount: super::uiautomationcore::ScrollAmount, verticalamount: super::uiautomationcore::ScrollAmount) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn ScrollPattern_Scroll(hobj : HUIAPATTERNOBJECT, horizontalamount : super::uiautomationcore::ScrollAmount, verticalamount : super::uiautomationcore::ScrollAmount) -> windows_core::HRESULT);
    unsafe { ScrollPattern_Scroll(hobj, horizontalamount, verticalamount) }
}
#[inline]
pub unsafe fn ScrollPattern_SetScrollPercent(hobj: HUIAPATTERNOBJECT, horizontalpercent: f64, verticalpercent: f64) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn ScrollPattern_SetScrollPercent(hobj : HUIAPATTERNOBJECT, horizontalpercent : f64, verticalpercent : f64) -> windows_core::HRESULT);
    unsafe { ScrollPattern_SetScrollPercent(hobj, horizontalpercent, verticalpercent) }
}
#[inline]
pub unsafe fn SelectionItemPattern_AddToSelection(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn SelectionItemPattern_AddToSelection(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { SelectionItemPattern_AddToSelection(hobj) }
}
#[inline]
pub unsafe fn SelectionItemPattern_RemoveFromSelection(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn SelectionItemPattern_RemoveFromSelection(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { SelectionItemPattern_RemoveFromSelection(hobj) }
}
#[inline]
pub unsafe fn SelectionItemPattern_Select(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn SelectionItemPattern_Select(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { SelectionItemPattern_Select(hobj) }
}
#[inline]
pub unsafe fn SynchronizedInputPattern_Cancel(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn SynchronizedInputPattern_Cancel(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { SynchronizedInputPattern_Cancel(hobj) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn SynchronizedInputPattern_StartListening(hobj: HUIAPATTERNOBJECT, inputtype: super::uiautomationcore::SynchronizedInputType) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn SynchronizedInputPattern_StartListening(hobj : HUIAPATTERNOBJECT, inputtype : super::uiautomationcore::SynchronizedInputType) -> windows_core::HRESULT);
    unsafe { SynchronizedInputPattern_StartListening(hobj, inputtype) }
}
#[cfg(feature = "oaidl")]
#[inline]
pub unsafe fn TextPattern_GetSelection(hobj: HUIAPATTERNOBJECT) -> windows_core::Result<*mut super::oaidl::SAFEARRAY> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_GetSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_GetSelection(hobj, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "oaidl")]
#[inline]
pub unsafe fn TextPattern_GetVisibleRanges(hobj: HUIAPATTERNOBJECT) -> windows_core::Result<*mut super::oaidl::SAFEARRAY> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_GetVisibleRanges(hobj : HUIAPATTERNOBJECT, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_GetVisibleRanges(hobj, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextPattern_RangeFromChild(hobj: HUIAPATTERNOBJECT, hnodechild: HUIANODE) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_RangeFromChild(hobj : HUIAPATTERNOBJECT, hnodechild : HUIANODE, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_RangeFromChild(hobj, hnodechild, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextPattern_RangeFromPoint(hobj: HUIAPATTERNOBJECT, point: super::uiautomationcore::UiaPoint) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_RangeFromPoint(hobj : HUIAPATTERNOBJECT, point : super::uiautomationcore::UiaPoint, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_RangeFromPoint(hobj, point, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextPattern_get_DocumentRange(hobj: HUIAPATTERNOBJECT) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_get_DocumentRange(hobj : HUIAPATTERNOBJECT, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_get_DocumentRange(hobj, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextPattern_get_SupportedTextSelection(hobj: HUIAPATTERNOBJECT) -> windows_core::Result<super::uiautomationcore::SupportedTextSelection> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextPattern_get_SupportedTextSelection(hobj : HUIAPATTERNOBJECT, pretval : *mut super::uiautomationcore::SupportedTextSelection) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextPattern_get_SupportedTextSelection(hobj, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_AddToSelection(hobj: HUIATEXTRANGE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_AddToSelection(hobj : HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe { TextRange_AddToSelection(hobj) }
}
#[inline]
pub unsafe fn TextRange_Clone(hobj: HUIATEXTRANGE) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_Clone(hobj : HUIATEXTRANGE, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_Clone(hobj, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_Compare(hobj: HUIATEXTRANGE, range: HUIATEXTRANGE) -> windows_core::Result<windows_core::BOOL> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_Compare(hobj : HUIATEXTRANGE, range : HUIATEXTRANGE, pretval : *mut windows_core::BOOL) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_Compare(hobj, range, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextRange_CompareEndpoints(hobj: HUIATEXTRANGE, endpoint: super::uiautomationcore::TextPatternRangeEndpoint, targetrange: HUIATEXTRANGE, targetendpoint: super::uiautomationcore::TextPatternRangeEndpoint) -> windows_core::Result<i32> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_CompareEndpoints(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::uiautomationcore::TextPatternRangeEndpoint, pretval : *mut i32) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_CompareEndpoints(hobj, endpoint, targetrange, targetendpoint, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextRange_ExpandToEnclosingUnit(hobj: HUIATEXTRANGE, unit: super::uiautomationcore::TextUnit) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_ExpandToEnclosingUnit(hobj : HUIATEXTRANGE, unit : super::uiautomationcore::TextUnit) -> windows_core::HRESULT);
    unsafe { TextRange_ExpandToEnclosingUnit(hobj, unit) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn TextRange_FindAttribute(hobj: HUIATEXTRANGE, attributeid: super::uiautomationcore::TEXTATTRIBUTEID, val: &super::oaidl::VARIANT, backward: bool) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_FindAttribute(hobj : HUIATEXTRANGE, attributeid : super::uiautomationcore::TEXTATTRIBUTEID, val : super::oaidl::VARIANT, backward : windows_core::BOOL, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_FindAttribute(hobj, attributeid, core::mem::transmute_copy(val), backward.into(), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_FindText(hobj: HUIATEXTRANGE, text: &windows_core::BSTR, backward: bool, ignorecase: bool) -> windows_core::Result<HUIATEXTRANGE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_FindText(hobj : HUIATEXTRANGE, text : *mut core::ffi::c_void, backward : windows_core::BOOL, ignorecase : windows_core::BOOL, pretval : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_FindText(hobj, core::mem::transmute_copy(text), backward.into(), ignorecase.into(), &mut result__).map(|| result__)
    }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn TextRange_GetAttributeValue(hobj: HUIATEXTRANGE, attributeid: super::uiautomationcore::TEXTATTRIBUTEID) -> windows_core::Result<super::oaidl::VARIANT> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_GetAttributeValue(hobj : HUIATEXTRANGE, attributeid : super::uiautomationcore::TEXTATTRIBUTEID, pretval : *mut super::oaidl::VARIANT) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_GetAttributeValue(hobj, attributeid, &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "oaidl")]
#[inline]
pub unsafe fn TextRange_GetBoundingRectangles(hobj: HUIATEXTRANGE) -> windows_core::Result<*mut super::oaidl::SAFEARRAY> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_GetBoundingRectangles(hobj : HUIATEXTRANGE, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_GetBoundingRectangles(hobj, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "oaidl")]
#[inline]
pub unsafe fn TextRange_GetChildren(hobj: HUIATEXTRANGE) -> windows_core::Result<*mut super::oaidl::SAFEARRAY> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_GetChildren(hobj : HUIATEXTRANGE, pretval : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_GetChildren(hobj, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_GetEnclosingElement(hobj: HUIATEXTRANGE) -> windows_core::Result<HUIANODE> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_GetEnclosingElement(hobj : HUIATEXTRANGE, pretval : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_GetEnclosingElement(hobj, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_GetText(hobj: HUIATEXTRANGE, maxlength: i32) -> windows_core::Result<windows_core::BSTR> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_GetText(hobj : HUIATEXTRANGE, maxlength : i32, pretval : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_GetText(hobj, maxlength, &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextRange_Move(hobj: HUIATEXTRANGE, unit: super::uiautomationcore::TextUnit, count: i32) -> windows_core::Result<i32> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_Move(hobj : HUIATEXTRANGE, unit : super::uiautomationcore::TextUnit, count : i32, pretval : *mut i32) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_Move(hobj, unit, count, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextRange_MoveEndpointByRange(hobj: HUIATEXTRANGE, endpoint: super::uiautomationcore::TextPatternRangeEndpoint, targetrange: HUIATEXTRANGE, targetendpoint: super::uiautomationcore::TextPatternRangeEndpoint) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByRange(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, targetrange : HUIATEXTRANGE, targetendpoint : super::uiautomationcore::TextPatternRangeEndpoint) -> windows_core::HRESULT);
    unsafe { TextRange_MoveEndpointByRange(hobj, endpoint, targetrange, targetendpoint) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn TextRange_MoveEndpointByUnit(hobj: HUIATEXTRANGE, endpoint: super::uiautomationcore::TextPatternRangeEndpoint, unit: super::uiautomationcore::TextUnit, count: i32) -> windows_core::Result<i32> {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_MoveEndpointByUnit(hobj : HUIATEXTRANGE, endpoint : super::uiautomationcore::TextPatternRangeEndpoint, unit : super::uiautomationcore::TextUnit, count : i32, pretval : *mut i32) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        TextRange_MoveEndpointByUnit(hobj, endpoint, unit, count, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn TextRange_RemoveFromSelection(hobj: HUIATEXTRANGE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_RemoveFromSelection(hobj : HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe { TextRange_RemoveFromSelection(hobj) }
}
#[inline]
pub unsafe fn TextRange_ScrollIntoView(hobj: HUIATEXTRANGE, aligntotop: bool) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_ScrollIntoView(hobj : HUIATEXTRANGE, aligntotop : windows_core::BOOL) -> windows_core::HRESULT);
    unsafe { TextRange_ScrollIntoView(hobj, aligntotop.into()) }
}
#[inline]
pub unsafe fn TextRange_Select(hobj: HUIATEXTRANGE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TextRange_Select(hobj : HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe { TextRange_Select(hobj) }
}
#[inline]
pub unsafe fn TogglePattern_Toggle(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TogglePattern_Toggle(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { TogglePattern_Toggle(hobj) }
}
#[inline]
pub unsafe fn TransformPattern_Move(hobj: HUIAPATTERNOBJECT, x: f64, y: f64) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TransformPattern_Move(hobj : HUIAPATTERNOBJECT, x : f64, y : f64) -> windows_core::HRESULT);
    unsafe { TransformPattern_Move(hobj, x, y) }
}
#[inline]
pub unsafe fn TransformPattern_Resize(hobj: HUIAPATTERNOBJECT, width: f64, height: f64) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TransformPattern_Resize(hobj : HUIAPATTERNOBJECT, width : f64, height : f64) -> windows_core::HRESULT);
    unsafe { TransformPattern_Resize(hobj, width, height) }
}
#[inline]
pub unsafe fn TransformPattern_Rotate(hobj: HUIAPATTERNOBJECT, degrees: f64) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn TransformPattern_Rotate(hobj : HUIAPATTERNOBJECT, degrees : f64) -> windows_core::HRESULT);
    unsafe { TransformPattern_Rotate(hobj, degrees) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaAddEvent(hnode: HUIANODE, eventid: super::uiautomationcore::EVENTID, pcallback: UiaEventCallback, scope: TreeScope, pproperties: *mut super::uiautomationcore::PROPERTYID, cproperties: i32, prequest: *mut UiaCacheRequest, phevent: *mut HUIAEVENT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaAddEvent(hnode : HUIANODE, eventid : super::uiautomationcore::EVENTID, pcallback : UiaEventCallback, scope : TreeScope, pproperties : *mut super::uiautomationcore::PROPERTYID, cproperties : i32, prequest : *mut UiaCacheRequest, phevent : *mut HUIAEVENT) -> windows_core::HRESULT);
    unsafe { UiaAddEvent(hnode, eventid, pcallback, scope, pproperties as _, cproperties, prequest as _, phevent as _) }
}
#[inline]
...
#[inline]
pub unsafe fn UiaDisconnectAllProviders() -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaDisconnectAllProviders() -> windows_core::HRESULT);
    unsafe { UiaDisconnectAllProviders() }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaDisconnectProvider<P0>(pprovider: P0) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    ...
    unsafe { UiaDisconnectProvider(pprovider.param().abi()) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn UiaEventAddWindow(hevent: HUIAEVENT, hwnd: super::windef::HWND) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaEventAddWindow(hevent : HUIAEVENT, hwnd : super::windef::HWND) -> windows_core::HRESULT);
    unsafe { UiaEventAddWindow(hevent, hwnd) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn UiaEventRemoveWindow(hevent: HUIAEVENT, hwnd: super::windef::HWND) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaEventRemoveWindow(hevent : HUIAEVENT, hwnd : super::windef::HWND) -> windows_core::HRESULT);
    unsafe { UiaEventRemoveWindow(hevent, hwnd) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaFind(hnode: HUIANODE, pparams: *mut UiaFindParams, prequest: *mut UiaCacheRequest, pprequesteddata: *mut *mut super::oaidl::SAFEARRAY, ppoffsets: *mut *mut super::oaidl::SAFEARRAY, pptreestructures: *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaFind(hnode : HUIANODE, pparams : *mut UiaFindParams, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, ppoffsets : *mut *mut super::oaidl::SAFEARRAY, pptreestructures : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe { UiaFind(hnode, pparams as _, prequest as _, pprequesteddata as _, ppoffsets as _, pptreestructures as _) }
}
#[inline]
pub unsafe fn UiaGetErrorDescription(pdescription: *mut windows_core::BSTR) -> windows_core::BOOL {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetErrorDescription(pdescription : *mut *mut core::ffi::c_void) -> windows_core::BOOL);
    unsafe { UiaGetErrorDescription(core::mem::transmute(pdescription)) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaGetPatternProvider(hnode: HUIANODE, patternid: super::uiautomationcore::PATTERNID) -> windows_core::Result<HUIAPATTERNOBJECT> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetPatternProvider(hnode : HUIANODE, patternid : super::uiautomationcore::PATTERNID, phobj : *mut HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaGetPatternProvider(hnode, patternid, &mut result__).map(|| result__)
    }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaGetPropertyValue(hnode: HUIANODE, propertyid: super::uiautomationcore::PROPERTYID) -> windows_core::Result<super::oaidl::VARIANT> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetPropertyValue(hnode : HUIANODE, propertyid : super::uiautomationcore::PROPERTYID, pvalue : *mut super::oaidl::VARIANT) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaGetPropertyValue(hnode, propertyid, &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn UiaGetReservedMixedAttributeValue() -> windows_core::Result<windows_core::IUnknown> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetReservedMixedAttributeValue(punkmixedattributevalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
pub unsafe fn UiaGetReservedNotSupportedValue() -> windows_core::Result<windows_core::IUnknown> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetReservedNotSupportedValue(punknotsupportedvalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn UiaGetRootNode() -> windows_core::Result<HUIANODE> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetRootNode(phnode : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaGetRootNode(&mut result__).map(|| result__)
    }
}
#[cfg(feature = "oaidl")]
#[inline]
pub unsafe fn UiaGetRuntimeId(hnode: HUIANODE) -> windows_core::Result<*mut super::oaidl::SAFEARRAY> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetRuntimeId(hnode : HUIANODE, pruntimeid : *mut *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaGetRuntimeId(hnode, &mut result__).map(|| result__)
    }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaGetUpdatedCache(hnode: HUIANODE, prequest: *mut UiaCacheRequest, normalizestate: NormalizeState, pnormalizecondition: *mut UiaCondition, pprequesteddata: *mut *mut super::oaidl::SAFEARRAY, pptreestructure: *mut windows_core::BSTR) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaGetUpdatedCache(hnode : HUIANODE, prequest : *mut UiaCacheRequest, normalizestate : NormalizeState, pnormalizecondition : *mut UiaCondition, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaGetUpdatedCache(hnode, prequest as _, normalizestate, pnormalizecondition as _, pprequesteddata as _, core::mem::transmute(pptreestructure)) }
}
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaHPatternObjectFromVariant(pvar: *mut super::oaidl::VARIANT, phobj: *mut HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaHPatternObjectFromVariant(pvar : *mut super::oaidl::VARIANT, phobj : *mut HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { UiaHPatternObjectFromVariant(pvar, phobj as _) }
}
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaHTextRangeFromVariant(pvar: *mut super::oaidl::VARIANT, phtextrange: *mut HUIATEXTRANGE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaHTextRangeFromVariant(pvar : *mut super::oaidl::VARIANT, phtextrange : *mut HUIATEXTRANGE) -> windows_core::HRESULT);
    unsafe { UiaHTextRangeFromVariant(pvar, phtextrange as _) }
}
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaHUiaNodeFromVariant(pvar: *mut super::oaidl::VARIANT, phnode: *mut HUIANODE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaHUiaNodeFromVariant(pvar : *mut super::oaidl::VARIANT, phnode : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe { UiaHUiaNodeFromVariant(pvar, phnode as _) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn UiaHasServerSideProvider(hwnd: super::windef::HWND) -> windows_core::BOOL {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaHasServerSideProvider(hwnd : super::windef::HWND) -> windows_core::BOOL);
    unsafe { UiaHasServerSideProvider(hwnd) }
}
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
#[inline]
pub unsafe fn UiaHostProviderFromHwnd(hwnd: super::windef::HWND) -> windows_core::Result<super::uiautomationcore::IRawElementProviderSimple> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaHostProviderFromHwnd(hwnd : super::windef::HWND, ppprovider : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaHostProviderFromHwnd(hwnd, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[cfg(all(feature = "oaidl", feature = "oleacc", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaIAccessibleFromProvider<P0>(pprovider: P0, dwflags: u32, ppaccessible: *mut Option<super::oleacc::IAccessible>, pvarchild: *mut super::oaidl::VARIANT) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaIAccessibleFromProvider(pprovider : *mut core::ffi::c_void, dwflags : u32, ppaccessible : *mut *mut core::ffi::c_void, pvarchild : *mut super::oaidl::VARIANT) -> windows_core::HRESULT);
    unsafe { UiaIAccessibleFromProvider(pprovider.param().abi(), dwflags, core::mem::transmute(ppaccessible), pvarchild) }
}
#[inline]
pub unsafe fn UiaLookupId(r#type: AutomationIdentifierType, pguid: *const windows_core::GUID) -> i32 {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaLookupId(r#type : AutomationIdentifierType, pguid : *const windows_core::GUID) -> i32);
    unsafe { UiaLookupId(r#type, pguid) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaNavigate(hnode: HUIANODE, direction: super::uiautomationcore::NavigateDirection, pcondition: *mut UiaCondition, prequest: *mut UiaCacheRequest, pprequesteddata: *mut *mut super::oaidl::SAFEARRAY, pptreestructure: *mut windows_core::BSTR) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNavigate(hnode : HUIANODE, direction : super::uiautomationcore::NavigateDirection, pcondition : *mut UiaCondition, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaNavigate(hnode, direction, pcondition as _, prequest as _, pprequesteddata as _, core::mem::transmute(pptreestructure)) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaNodeFromFocus(prequest: *mut UiaCacheRequest, pprequesteddata: *mut *mut super::oaidl::SAFEARRAY, pptreestructure: *mut windows_core::BSTR) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNodeFromFocus(prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaNodeFromFocus(prequest as _, pprequesteddata as _, core::mem::transmute(pptreestructure)) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn UiaNodeFromHandle(hwnd: super::windef::HWND) -> windows_core::Result<HUIANODE> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNodeFromHandle(hwnd : super::windef::HWND, phnode : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaNodeFromHandle(hwnd, &mut result__).map(|| result__)
    }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaNodeFromPoint(x: f64, y: f64, prequest: *mut UiaCacheRequest, pprequesteddata: *mut *mut super::oaidl::SAFEARRAY, pptreestructure: *mut windows_core::BSTR) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNodeFromPoint(x : f64, y : f64, prequest : *mut UiaCacheRequest, pprequesteddata : *mut *mut super::oaidl::SAFEARRAY, pptreestructure : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaNodeFromPoint(x, y, prequest as _, pprequesteddata as _, core::mem::transmute(pptreestructure)) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaNodeFromProvider<P0>(pprovider: P0) -> windows_core::Result<HUIANODE>
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNodeFromProvider(pprovider : *mut core::ffi::c_void, phnode : *mut HUIANODE) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaNodeFromProvider(pprovider.param().abi(), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn UiaNodeRelease(hnode: HUIANODE) -> windows_core::BOOL {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaNodeRelease(hnode : HUIANODE) -> windows_core::BOOL);
    unsafe { UiaNodeRelease(hnode) }
}
#[inline]
pub unsafe fn UiaPatternRelease(hobj: HUIAPATTERNOBJECT) -> windows_core::BOOL {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaPatternRelease(hobj : HUIAPATTERNOBJECT) -> windows_core::BOOL);
    unsafe { UiaPatternRelease(hobj) }
}
#[cfg(all(feature = "uiautomationcore", feature = "windef"))]
#[inline]
pub unsafe fn UiaProviderForNonClient(hwnd: super::windef::HWND, idobject: i32, idchild: i32) -> windows_core::Result<super::uiautomationcore::IRawElementProviderSimple> {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaProviderForNonClient(hwnd : super::windef::HWND, idobject : i32, idchild : i32, ppprovider : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        UiaProviderForNonClient(hwnd, idobject, idchild, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[cfg(all(feature = "oaidl", feature = "oleacc", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaProviderFromIAccessible<P0>(paccessible: P0, idchild: i32, dwflags: u32) -> windows_core::Result<super::uiautomationcore::IRawElementProviderSimple>
where
    P0: windows_core::Param<super::oleacc::IAccessible>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaProviderFromIAccessible(paccessible : *mut core::ffi::c_void, idchild : i32, dwflags : u32, ppprovider : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaRaiseActiveTextPositionChangedEvent<P0, P1>(provider: P0, textrange: P1) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
    P1: windows_core::Param<super::uiautomationcore::ITextRangeProvider>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseActiveTextPositionChangedEvent(provider : *mut core::ffi::c_void, textrange : *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaRaiseActiveTextPositionChangedEvent(provider.param().abi(), textrange.param().abi()) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaRaiseAsyncContentLoadedEvent<P0>(pprovider: P0, asynccontentloadedstate: AsyncContentLoadedState, percentcomplete: f64) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseAsyncContentLoadedEvent(pprovider : *mut core::ffi::c_void, asynccontentloadedstate : AsyncContentLoadedState, percentcomplete : f64) -> windows_core::HRESULT);
    unsafe { UiaRaiseAsyncContentLoadedEvent(pprovider.param().abi(), asynccontentloadedstate, percentcomplete) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaRaiseAutomationEvent<P0>(pprovider: P0, id: super::uiautomationcore::EVENTID) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationEvent(pprovider : *mut core::ffi::c_void, id : super::uiautomationcore::EVENTID) -> windows_core::HRESULT);
    unsafe { UiaRaiseAutomationEvent(pprovider.param().abi(), id) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaRaiseAutomationPropertyChangedEvent<P0>(pprovider: P0, id: super::uiautomationcore::PROPERTYID, oldvalue: &super::oaidl::VARIANT, newvalue: &super::oaidl::VARIANT) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseAutomationPropertyChangedEvent(pprovider : *mut core::ffi::c_void, id : super::uiautomationcore::PROPERTYID, oldvalue : super::oaidl::VARIANT, newvalue : super::oaidl::VARIANT) -> windows_core::HRESULT);
    unsafe { UiaRaiseAutomationPropertyChangedEvent(pprovider.param().abi(), id, core::mem::transmute_copy(oldvalue), core::mem::transmute_copy(newvalue)) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn UiaRaiseChangesEvent<P0>(pprovider: P0, eventidcount: i32, puiachanges: *mut super::uiautomationcore::UiaChangeInfo) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseChangesEvent(pprovider : *mut core::ffi::c_void, eventidcount : i32, puiachanges : *mut super::uiautomationcore::UiaChangeInfo) -> windows_core::HRESULT);
    unsafe { UiaRaiseChangesEvent(pprovider.param().abi(), eventidcount, puiachanges) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaRaiseNotificationEvent<P0>(provider: P0, notificationkind: super::uiautomationcore::NotificationKind, notificationprocessing: super::uiautomationcore::NotificationProcessing, displaystring: &windows_core::BSTR, activityid: &windows_core::BSTR) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseNotificationEvent(provider : *mut core::ffi::c_void, notificationkind : super::uiautomationcore::NotificationKind, notificationprocessing : super::uiautomationcore::NotificationProcessing, displaystring : *mut core::ffi::c_void, activityid : *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { UiaRaiseNotificationEvent(provider.param().abi(), notificationkind, notificationprocessing, core::mem::transmute_copy(displaystring), core::mem::transmute_copy(activityid)) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn UiaRaiseStructureChangedEvent<P0>(pprovider: P0, structurechangetype: super::uiautomationcore::StructureChangeType, pruntimeid: *mut i32, cruntimeidlen: i32) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseStructureChangedEvent(pprovider : *mut core::ffi::c_void, structurechangetype : super::uiautomationcore::StructureChangeType, pruntimeid : *mut i32, cruntimeidlen : i32) -> windows_core::HRESULT);
    unsafe { UiaRaiseStructureChangedEvent(pprovider.param().abi(), structurechangetype, pruntimeid as _, cruntimeidlen) }
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
#[inline]
pub unsafe fn UiaRaiseTextEditTextChangedEvent<P0>(pprovider: P0, texteditchangetype: super::uiautomationcore::TextEditChangeType, pchangeddata: *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRaiseTextEditTextChangedEvent(pprovider : *mut core::ffi::c_void, texteditchangetype : super::uiautomationcore::TextEditChangeType, pchangeddata : *mut super::oaidl::SAFEARRAY) -> windows_core::HRESULT);
    unsafe { UiaRaiseTextEditTextChangedEvent(pprovider.param().abi(), texteditchangetype, pchangeddata as _) }
}
#[cfg(all(feature = "oaidl", feature = "windef"))]
#[inline]
pub unsafe fn UiaRegisterProviderCallback(pcallback: UiaProviderCallback) {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRegisterProviderCallback(pcallback : UiaProviderCallback));
    unsafe { UiaRegisterProviderCallback(pcallback) }
}
#[inline]
pub unsafe fn UiaRemoveEvent(hevent: HUIAEVENT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaRemoveEvent(hevent : HUIAEVENT) -> windows_core::HRESULT);
    unsafe { UiaRemoveEvent(hevent) }
}
#[cfg(all(feature = "minwindef", feature = "uiautomationcore", feature = "windef"))]
#[inline]
pub unsafe fn UiaReturnRawElementProvider<P3>(hwnd: super::windef::HWND, wparam: super::minwindef::WPARAM, lparam: super::minwindef::LPARAM, el: P3) -> super::minwindef::LRESULT
where
    P3: windows_core::Param<super::uiautomationcore::IRawElementProviderSimple>,
{
    windows_core::link!("uiautomationcore.dll" "system" fn UiaReturnRawElementProvider(hwnd : super::windef::HWND, wparam : super::minwindef::WPARAM, lparam : super::minwindef::LPARAM, el : *mut core::ffi::c_void) -> super::minwindef::LRESULT);
    unsafe { UiaReturnRawElementProvider(hwnd, wparam, lparam, el.param().abi()) }
}
#[inline]
pub unsafe fn UiaSetFocus(hnode: HUIANODE) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaSetFocus(hnode : HUIANODE) -> windows_core::HRESULT);
    unsafe { UiaSetFocus(hnode) }
}
#[inline]
pub unsafe fn UiaTextRangeRelease(hobj: HUIATEXTRANGE) -> windows_core::BOOL {
    windows_core::link!("uiautomationcore.dll" "system" fn UiaTextRangeRelease(hobj : HUIATEXTRANGE) -> windows_core::BOOL);
    unsafe { UiaTextRangeRelease(hobj) }
}
#[inline]
pub unsafe fn ValuePattern_SetValue<P1>(hobj: HUIAPATTERNOBJECT, pval: P1) -> windows_core::HRESULT
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ValuePattern_SetValue(hobj, pval.param().abi()) }
}
#[inline]
pub unsafe fn VirtualizedItemPattern_Realize(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn VirtualizedItemPattern_Realize(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { VirtualizedItemPattern_Realize(hobj) }
}
#[inline]
pub unsafe fn WindowPattern_Close(hobj: HUIAPATTERNOBJECT) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn WindowPattern_Close(hobj : HUIAPATTERNOBJECT) -> windows_core::HRESULT);
    unsafe { WindowPattern_Close(hobj) }
}
#[cfg(feature = "uiautomationcore")]
#[inline]
pub unsafe fn WindowPattern_SetWindowVisualState(hobj: HUIAPATTERNOBJECT, state: super::uiautomationcore::WindowVisualState) -> windows_core::HRESULT {
    windows_core::link!("uiautomationcore.dll" "system" fn WindowPattern_SetWindowVisualState(hobj : HUIAPATTERNOBJECT, state : super::uiautomationcore::WindowVisualState) -> windows_core::HRESULT);
    unsafe { WindowPattern_SetWindowVisualState(hobj, state) }
}
#[inline]
pub unsafe fn WindowPattern_WaitForInputIdle(hobj: HUIAPATTERNOBJECT, milliseconds: i32) -> windows_core::Result<windows_core::BOOL> {
    windows_core::link!("uiautomationcore.dll" "system" fn WindowPattern_WaitForInputIdle(hobj : HUIAPATTERNOBJECT, milliseconds : i32, presult : *mut windows_core::BOOL) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        WindowPattern_WaitForInputIdle(hobj, milliseconds, &mut result__).map(|| result__)
    }
}
...
pub const AsyncContentLoadedState_Beginning: AsyncContentLoadedState = 0;
pub const AsyncContentLoadedState_Completed: AsyncContentLoadedState = 2;
pub const AsyncContentLoadedState_Progress: AsyncContentLoadedState = 1;
...
pub const AutomationIdentifierType_Annotation: AutomationIdentifierType = 6;
pub const AutomationIdentifierType_Changes: AutomationIdentifierType = 7;
pub const AutomationIdentifierType_ControlType: AutomationIdentifierType = 3;
pub const AutomationIdentifierType_Event: AutomationIdentifierType = 2;
pub const AutomationIdentifierType_LandmarkType: AutomationIdentifierType = 5;
pub const AutomationIdentifierType_Pattern: AutomationIdentifierType = 1;
pub const AutomationIdentifierType_Property: AutomationIdentifierType = 0;
pub const AutomationIdentifierType_Style: AutomationIdentifierType = 8;
pub const AutomationIdentifierType_TextAttribute: AutomationIdentifierType = 4;
...
pub const ConditionType_And: ConditionType = 3;
pub const ConditionType_False: ConditionType = 1;
pub const ConditionType_Not: ConditionType = 5;
pub const ConditionType_Or: ConditionType = 4;
pub const ConditionType_Property: ConditionType = 2;
pub const ConditionType_True: ConditionType = 0;
...
pub const EventArgsType_ActiveTextPositionChanged: EventArgsType = 8;
pub const EventArgsType_AsyncContentLoaded: EventArgsType = 3;
pub const EventArgsType_Changes: EventArgsType = 6;
pub const EventArgsType_Notification: EventArgsType = 7;
pub const EventArgsType_PropertyChanged: EventArgsType = 1;
pub const EventArgsType_Simple: EventArgsType = 0;
pub const EventArgsType_StructureChanged: EventArgsType = 2;
pub const EventArgsType_StructuredMarkup: EventArgsType = 9;
pub const EventArgsType_TextEditTextChanged: EventArgsType = 5;
pub const EventArgsType_WindowClosed: EventArgsType = 4;
...
pub const NormalizeState_Custom: NormalizeState = 2;
pub const NormalizeState_None: NormalizeState = 0;
pub const NormalizeState_View: NormalizeState = 1;
...
pub const ProviderType_BaseHwnd: ProviderType = 0;
pub const ProviderType_NonClientArea: ProviderType = 2;
pub const ProviderType_Proxy: ProviderType = 1;
...
pub struct UiaCacheRequest {
    ...
    pub Scope: TreeScope,
    pub pProperties: *mut super::uiautomationcore::PROPERTYID,
    pub cProperties: i32,
    pub pPatterns: *mut super::uiautomationcore::PATTERNID,
    pub cPatterns: i32,
...
pub struct UiaChangesEventArgs {
    ...
    pub pUiaChanges: *mut super::uiautomationcore::UiaChangeInfo,
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
...
#[cfg(feature = "oaidl")]
pub type UiaEventCallback = Option<unsafe extern "system" fn(pargs: *mut UiaEventArgs, prequesteddata: *mut super::oaidl::SAFEARRAY, ptreestructure: windows_core::Ref<windows_core::BSTR>)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
pub struct UiaPropertyChangedEventArgs {
    pub Type: EventArgsType,
    pub EventId: i32,
    pub PropertyId: super::uiautomationcore::PROPERTYID,
    pub OldValue: super::oaidl::VARIANT,
    pub NewValue: super::oaidl::VARIANT,
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore", feature = "wtypes", feature = "wtypesbase"))]
...
#[cfg(all(feature = "oaidl", feature = "windef"))]
pub type UiaProviderCallback = Option<unsafe extern "system" fn(hwnd: super::windef::HWND, providertype: ProviderType) -> *mut super::oaidl::SAFEARRAY>;
...
pub struct UiaStructureChangedEventArgs {
    pub Type: EventArgsType,
    pub EventId: i32,
    pub StructureChangeType: super::uiautomationcore::StructureChangeType,
...
pub struct UiaTextEditTextChangedEventArgs {
    pub Type: EventArgsType,
    pub EventId: i32,
    pub TextEditChangeType: super::uiautomationcore::TextEditChangeType,
    pub pTextChange: *mut super::oaidl::SAFEARRAY,
}
#[cfg(all(feature = "oaidl", feature = "uiautomationcore"))]
