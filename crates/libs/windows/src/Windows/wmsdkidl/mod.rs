...
pub trait IWMSyncReader_Impl: windows_core::IUnknownImpl {
    ...
    fn GetNextSample(&self, wstreamnum: u16, ppsample: windows_core::OutRef<super::wmsbuffer::INSSBuffer>, pcnssampletime: *mut u64, pcnsduration: *mut u64, pdwflags: *mut u32, pdwoutputnum: *mut u32, pwstreamnum: *mut u16) -> windows_core::Result<()>;
    fn SetStreamsSelected(&self, cstreamcount: u16, pwstreamnumbers: *const u16, pselections: *const WMT_STREAM_SELECTION) -> windows_core::Result<()>;
    fn GetStreamSelected(&self, wstreamnum: u16) -> windows_core::Result<WMT_STREAM_SELECTION>;
...
pub trait IWMWriter_Impl: windows_core::IUnknownImpl {
    ...
    fn AllocateSample(&self, dwsamplesize: u32) -> windows_core::Result<super::wmsbuffer::INSSBuffer>;
...
pub trait IWMWriterAdvanced_Impl: windows_core::IUnknownImpl {
    ...
    fn WriteStreamSample(&self, wstreamnum: u16, cnssampletime: u64, mssamplesendtime: u32, cnssampleduration: u64, dwflags: u32, psample: windows_core::Ref<super::wmsbuffer::INSSBuffer>) -> windows_core::Result<()>;
...
pub trait IWMWriterSink_Impl: windows_core::IUnknownImpl {
    ...
    fn IsRealTime(&self) -> windows_core::Result<windows_core::BOOL>;
    fn AllocateDataUnit(&self, cbdataunit: u32) -> windows_core::Result<super::wmsbuffer::INSSBuffer>;
...
pub struct WM_READER_CLIENTINFO {
    ...
    pub qwReserved: u64,
    pub pReserved: *mut super::minwindef::LPARAM,
